...
export default function Header() {
  ...
  return (
    <header className='bg-blue-900 py-3 px-4 shadow-md font-extralight'>
      <div className='flex justify-between items-center max-w-6xl mx-auto'>
        <Link to='/'>
          <h1 className='font-bold text-xl sm:text-2xl flex flex-wrap text-white'>
            <FaHome aria-hidden='true' />
            <span className='ml-2'>JVBReal</span>
